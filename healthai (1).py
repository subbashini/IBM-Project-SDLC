...
Original file is located at
    https://colab.research.google.com/drive/1CbYTj0QqxH4erPjJZnz6izws1lsHBK2k
"""
        ...
        with gr.TabItem("Eco Tips Generator"):
            with gr.Row():
                with gr.Column():
                    ...
                    analyze_btn = gr.Button("Generate Eco Tips")

                with gr.Column():
                    analysis_output = gr.Textbox(label="Sustainable Living Tips", lines=20)
